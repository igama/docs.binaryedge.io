# Sensors Available Tags 
 ...
 | APACHE_JSERVE_SCANNER | The Apache JServ Protocol (AJP) is a binary protocol that can proxy inbound requests from a web server through to an application server that sits behind the web server. |
 ...
 | GENERICLINES_SCANNER | Normal new line scanner, typically initial probe |  
 ...
 | IKE_SCANNER | Ike VPN protocol scanner |
 ...
 | SERVICES_HELP_SCANNER | Services Help Scanner | 
